...
const FAQ_ITEMS = [
  ...
  ["What is Pro?", "Optional upgrades: who viewed your profile, a custom accent color and animated avatar, unlimited AI, a badge, and early access to new features. Billing comes later at $4.99/mo or $19.99/yr."],
] as const;
