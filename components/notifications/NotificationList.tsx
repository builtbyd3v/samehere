...
function Avatar({ url, name, type, reactionType }: { url: string | null; name: string; type: NotificationRow["type"]; reactionType: NotificationRow["reaction_type"] }) {
  return (
      ...
      {items.map((n) => {
        ...
        return (
          <li key={n.id} className="relative">
            ...
            >
              <Avatar url={n.actor_avatar_url} name={actorName} type={n.type} reactionType={n.reaction_type} />
