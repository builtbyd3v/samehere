...
export default function QuoteRepostModal({
  ...
  return (
    ...
    >
      <div
        className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl border border-[var(--border)] bg-[var(--surface-card)] p-4 shadow-paper animate-[modal-in_200ms_var(--ease-out)] motion-reduce:animate-none sm:p-5"
